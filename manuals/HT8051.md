...
**Tabella 1**: Elenco rampe disponibili per la corrente/tensione di uscita
...
### 5.4. GENERAZIONE DI CORRENTE DC
...
**Fig. 8**: Simulazione di un trasduttore
...
Modo `SOUR mA` → max carico ammesso `1 kΩ` `@ 20mA`.
